...
test_imgs = r'C:\Users\Amaya\Documents\PhD\Data\IHC synovium segmentation\Test\img/'   ## full-scale images
test_masks = r'C:\Users\Amaya\Documents\PhD\Data\IHC synovium segmentation\Test\GT/'  ## full-scale ground truths
...
path_to_save_visual_results= r'C:\Users\Amaya\Documents\PhD\Data\IHC synovium segmentation\resultsv2/'
...
class Dataset_Val(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img_patches, mask,img_indices, self.images[index][:-4], image_tensor
...
def check_dice_score(test_loader, model, device=DEVICE):
    ...
    with torch.no_grad():
        ...
        for batch_idx, (img_patches, t1, mask_indices, label, image) in enumerate(loop):
            ...
            dice_score = (2 * (merged_pre * t1).sum()) / (
                (merged_pre + t1).sum() + 1e-8
            )
...
#            print(t1.shape)
            ...
            del image, t1, merged_pre, result, pred1
            gc.collect()
